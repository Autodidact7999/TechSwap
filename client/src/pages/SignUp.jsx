...
const SignUpNew = () => {
  ...
  const handleEmailChange = (e) => {
    ...
    if (e.target.value.includes("mod.techswap.com")) {
      setIsModerator(true);
    } else {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("Password:", '[PROTECTED]'); // Don't log actual passwords
    console.log("Avatar:", avatar ? avatar.name : 'No avatar');
    console.log("Role:", "general");
    console.log("Is Consent Given:", isConsentGiven.toString());
    ...
    if (avatar) {
      ...
      // Additional debug to view FormData contents
    ...
    console.log("Form data from pages:", formData.get("name"));
    ...
    try {
      ...
      setLoadingText("Failed to sign up. Please try again.");
    } finally {
      setLoading(false);
