...
// const { verifyEmail, verifyEmailValidation } = require("../middlewares/users/verifyEmail");

// // Make sure the path here corresponds to what you expect from the client-side
// router.get('/auth/verify', verifyEmailValidation, verifyEmail);
